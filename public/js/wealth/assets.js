(function(g){
  ...
  async function save(id){
    try{
      ...
      var b={name:H.val('as_name'),asset_type:t,symbol:H.val('as_symbol'),isin:H.val('as_isin'),exchange:H.val('as_exchange'),scheme_code:H.val('as_scheme_code'),currency:H.val('as_currency')||'INR',price_source:H.val('as_src'),pricing_mode:H.val('as_mode'),valuation_mode:H.val('as_val_mode')||null,is_active:H.val('as_active'),notes:H.val('as_notes'),metadata:meta};
